 ...
 */
 ...
 /**
 * Добавил время жизни кеширования для передачи в DB_cache
...
class CI_DB_driver {
    ...
    var $cache_live_time    = 0;// бесконечно, до обновления таблицы
	...
	function query($sql, $binds = FALSE, $return_object = TRUE)
	{
        ...
        if ($this->cache_on == TRUE AND stristr($sql, 'SELECT'))
		{
			...
			{              
				$this->load_rdriver();
				if (FALSE !== ($cache = $this->CACHE->read($sql, $this->cache_live_time)))
				{
					return $cache;
				}
			}
	 ...
	 *
	 * @access	public
     * @param int $cache_live_time Сколько хранить кеш, в секундах
	 * @return	void
	 */
	function cache_on($cache_live_time=0)
	{
