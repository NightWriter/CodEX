...
class DateTimeField extends codexForms
{
    function DateTimeField($name,$params) { 
	...
	function getHTML()
	{
        ...
        //$CI->codextemplates->cssFromAssets('css-datepicker','themes/ui-lightness/ui.datepicker.css');
