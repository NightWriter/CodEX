...
/*		array (
	...
	$cfg['ilibs_dir'] 	   = array('./codex/assets/js/tiny_mce/plugins/ibrowser/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
