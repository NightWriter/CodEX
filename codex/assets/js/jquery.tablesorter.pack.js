			...
			this.construct = function(settings) {
				...
				return this.each(function() {
					...
					$headers.click(function(e) {
                        ...
                        {
                            //
                            $headers.removeClass('loadingSort');
                            //
                            jQuery(this).addClass('loadingSort');
                            
                            var order_type = this.order == 0 ?'ASC':'DESC';
                            $.post(config.controllerLink,{query:config.query,field:config.field,per_page:config.size,page:config.page,order_by:jQuery(this).attr('id'),order_type:order_type},function(data){
                                if(data){
                                    $headers.removeClass('loadingSort');
